...
# CSV Reader using ASP.NET MVC5 📝

Welcome to CSVReader! I built this application because I wanted to build the small app using the ASP.NET MVC5 framework, and so I did it!. I hope that you enjoy playing around with this application just as much as I enjoyed building it.
<p align="center">
<img src="SynelTestProject/App_Data/CSV Reader.gif">
</p>

## Notes
Please, open the `task.docx` file in order to understand what I wanted to build.
...
Project Link: [https://github.com/nodirbeknabiev98/CSVReader](https://github.com/nodirbeknabiev98/CSVReader)
